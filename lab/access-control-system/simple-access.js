...
function runSimpleDemo() {
    ...
    accessManager.grantAccess('document_1', 'alice', 
    ...
    accessManager.grantAccess('document_1', 'bob', 
        combinePermissions(Permissions.VIEW, Permissions.EDIT), 'alice');
    ...
    accessManager.grantAccess('spreadsheet_2', 'alice', 
        combinePermissions(Permissions.VIEW, Permissions.EDIT, Permissions.DELETE, Permissions.SHARE));
    ...
    accessManager.grantAccess('presentation_3', 'charlie', 
        combinePermissions(Permissions.VIEW, Permissions.EDIT, Permissions.DELETE, Permissions.SHARE));
