# DFinity LLM Repository - Original lib.rs

**Source**: Official DFinity LLM repository  
**Purpose**: Reference implementation of the ic-llm crate  
**Version**: 1.1.0
...
- This is the complete original lib.rs from the DFinity LLM repository
- Contains the main API functions: `prompt()`, `chat()`, `tool()`, `parameter()`
- Uses `ic-cdk = "0.17.1"` dependency
- All functionality is self-contained in this file plus the chat.rs and tool.rs modules
