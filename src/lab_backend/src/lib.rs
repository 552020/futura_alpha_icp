...
#[update]
fn run_experiment_simple(experiment_name: String) -> ExperimentResult {
    ExperimentResult {
        success: true,
...
#[query]
fn greet_robust(name: String) -> Result<String, String> {
...
#[update]
fn run_experiment_robust(experiment_name: String) -> Result<ExperimentData, String> {
...
#[query]
fn get_status_robust() -> Result<String, String> {
